...
let s:palette.bgref     = {'dark': "#1F2430",  'light': "#ffffff",  'mirage': "#ffffff"}

let s:palette.lsp_warn  = { 'dark': "#FFDC00", 'light': "#ffffff", 'mirage': "#ffffff"}
let s:palette.lsp_error = { 'dark': "#85144b", 'light': "#ffffff", 'mirage': "#ffffff"}
...
let s:palette.cursor    = {'dark': "#a30aa3",  'light': "#ffffff",  'mirage': "#ffffff"}
...
let s:palette.colorcol  = {'dark': "#3c3836",  'light': "#F3F3F3",  'mirage': "#242B38"}
...
exe "hi! StatusLineTerm"    .s:fg_fg          .s:bg_panel       .s:fmt_none
...
exe "hi! Todo"            .s:fg_comment   .s:bg_none        .s:fmt_bold
...
exe "hi! lspReference"    .s:fg_fg        .s:bg_bgref       .s:fmt_none
